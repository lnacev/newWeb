  ...
  <body>
      ...
      <div id="main-case">
          ...
          <div class="table-wrap">
              ...
              <div class="table-top">
                  <h1>Produktové kategorie</h1>
                  <div class="table-top-right">
                        <a class="add-link" href="category-detail.php" title="Přidat novou kategorii">Přidat novou kategorii</a>
                        <div id="search">
                            <form action="" method="post">
                            <fieldset>
                            <input id="search-input" type="text" title="Zde napište hledaný text" value="Název nebo ID kategorie" onfocus="if(this.value=='Název nebo ID kategorie') this.value=''" />
...
?>
                        <tr>
                            ...
                            <th class="id">ID</th>
                            <th class="category-list-name">Název kategorie</th>
                            <!--<th class="category-list-count">Počet produktů</th>-->
...
while($radek = $vysledek->row()) {                     
  echo "<tr class=\"table-hover\">
                            ...
                            <td class=\"category-list-name\"><a href=\"\" title=\"\">".$radek['nazev']."</a></td>
                            <!--<td class=\"category-list-count\">261</td>-->
