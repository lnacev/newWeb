  ...
  <body>
      ...
      <div id="main-case">
          ...
          <div class="table-wrap">
              ...
              <div class="table-top">
                  <h1>Výrobci (značky)</h1>
                  <div class="table-top-right">
                        <a class="add-link" href="manufacturer-detail.php" title="Přidat nového výrobce">Přidat nového výrobce</a>
                        <div id="search">
                            <form action="" method="post">
                            <fieldset>
                            <input id="search-input" type="text" title="Zde napište hledaný text" value="Název nebo ID výrobce" onfocus="if(this.value=='Název nebo ID výrobce') this.value=''" />
                  ...
                  <div class="filter">
                      ...
                      <p>
                          ...
                          <select name="filter-products-count">
                              <option  value="">Od nejvíce produktů</option>
                              <option  value="">Od nejméně produktů</option>
                          </select>
                      </p>
...
?>
                        <tr>
                            ...
                            <th class="id">ID</th>
                            <th class="manufacturer-list-name">Název</th>
                            <!--<th class="manufacturer-list-count">Počet produktů</th>-->
...
while($radek = $vysledek->row()) {                     
  echo "<tr class=\"table-hover\">
                            ...
                            <td class=\"manufacturer-list-name\"><a href=\"\" title=\"\">".$radek['nazev']."</a></td>
                            <!--<td class=\"manufacturer-list-count\">".$radek['id']."</td>-->
