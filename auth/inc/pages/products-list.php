...
*/
//
$dotaz = $db->select('sh_products.nazev:productname', 'sh_categories.name:katname', 'sh_categories.nazev:katnazev', 'sh_type.lov_dirky:rybolov1', 'sh_type.zavody:rybolov2', 'sh_type.rybareni:rybolov3', 'sh_sale.procento:test', 'datum', 'cena', 'rezervace', 'last_minute', 'novinka', 'akce', 'sh_products.id', 'id_stranky', 'pictures') //
    ->from('sh_products')//
    ->joinOn('sh_product_kat', '`sh_products`.`id`=`sh_product_kat`.`produkty`', 'LEFT') //
    ->joinOn('sh_type', '`sh_products`.`type_id`=`sh_type`.`id`', 'LEFT') //
    ->joinOn('sh_sale', '`sh_products`.`sleva_id`=`sh_sale`.`id`', 'LEFT') //    
                  ...
                  <table class="list">
                      <tbody>
                        <tr>
                            ...
                            <th class="product-list-cat">Objekt</th>
                            <th class="product-list-manufacturer">Rybolov</th>
                            <th class="product-list-sex">Rezervace</th>
                            <th class="product-list-size">Last minute</th>
                            <th class="product-list-count">Novinka</th>
                            <th class="product-list-price-old">Cena Kč</th>
...
while($radek = $vysledek->row()) {                     
  echo "<tr class=\"table-hover\">
                            ...
                            <td class=\"product-list-cat\">".$radek['katnazev']."</td>
                            <td class=\"product-list-manufacturer\">".$radek['rybolov1'].$radek['rybolov2'].$radek['rybolov3']."</td>
                            <td class=\"product-list-sex\">".$radek['rezervace']."</td>
                            <td class=\"product-list-size\">".$radek['last_minute']."</td>
                            <td class=\"product-list-count\">".$radek['novinka']."</td>
                            <td class=\"product-list-price-old\">".$radek['cena']."</td>
                            <td class=\"product-list-price-new\">&nbsp;</td> 
                            <td class=\"product-list-discount\">".$radek['test']."</td>
