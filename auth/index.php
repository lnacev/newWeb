...
//require_once "inc/config/constants.inc.php";
//var_dump($_SESSION); 
//print_r($_SERVER);
//var_dump($_SERVER);
?>
  ...
  <body>
      <div id="top-case">
              ...
              <ul id="menu">
                  ...
                  <li class="menu-item"><a class="menu-link" href="inc/pages/products-list.php" title="Produkty">PRODUKTY</a>
                      <div class="sub-menu-wrap">
                          <ul class="sub-menu">
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/products-list.php" title="">Výpis produktů</a></li>
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/products-detail.php" title="">Přidat produkt</a></li>
                          </ul>
                      </div>
                  </li>
                  <li class="menu-item"><a class="menu-link" href="inc/pages/manufacturer-list.php" title="Výrobci">VÝROBCI</a>
                      <div class="sub-menu-wrap">
                          <ul class="sub-menu">
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/manufacturer-list.php" title="">Výpis výrobců</a></li>
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/manufacturer-detail.php" title="">Přidat výrobce</a></li>
                          </ul>
                      </div>
                  </li>
                  <li class="menu-item"><a class="menu-link" href="inc/pages/category-list.php" title="Kategorie produktů">KATEGORIE</a>
                      <div class="sub-menu-wrap">
                          <ul class="sub-menu">
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/category-list.php" title="">Výpis kategorií</a></li>
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/category-detail.php" title="">Přidat kategorii</a></li>
                          </ul>
                      </div>
                  </li>
                  <li class="menu-item"><a class="menu-link" href="inc/pages/order-list-new-order.php" title="Objednávky">OBJEDNÁVKY</a>
                      <div class="sub-menu-wrap">
                          <ul class="sub-menu">
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/order-list-new-order.php" title="">Nové objednávky</a></li>
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/order-list-ok-order.php" title="">Vyřízené objednávky</a></li>
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/order-list-storno-order.php" title="">Stornované objednávky</a></li>
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/order-detail.php" title="">Přidat objednávku</a></li>
                          </ul>
                      </div>
                  </li>
                  <li class="menu-item"><a class="menu-link" href="inc/pages/customer-list.php" title="Zákazníci">ZÁKAZNÍCI</a>
                      <div class="sub-menu-wrap">
                          <ul class="sub-menu">
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/customer-list.php" title="">Výpis zákazníků</a></li>
                              <li class="sub-menu-item"><a class="sub-menu-link" href="inc/pages/customer-detail.php" title="">Přidat zákazníka</a></li>
                          </ul>
                      </div>
                  </li>
              ...
              <div id="login-status">
                  <a href="" title="Nastavení účtu">Radek Fišera</a>
                  <a href="" title="Odhlásit se" class="logout-link"><!-- --></a>
              </div>
              <div class="clear"></div>
...
<!--              
              <div class="table-top">
                  ...
                  <div class="table-top-right">
                        <a class="add-link" href="inc/pages/products-detail.php" title="Přidat nový produkt">Přidat nový produkt</a>
                        <div id="search">
...
//
$dotaz = $db->select('sh_products.nazev:productname', 'sh_categories.name:katname', 'sh_categories.nazev:katnazev', 'ean', 'datum', 'www', 'cena', 'pohlavi', 'tip_produktu', 'sh_products.id', 'id_stranky', 'pictures') //
    ->from('sh_products')//
                  ...
                  <table class="list">
                      <tbody>
                        <tr>
                            ...
                            <th class="product-list-count">Počet</th>
...
while($radek = $vysledek->row()) {                     
  echo "<tr class=\"table-hover\">
                            ...
                            <td class=\"id\">2321</td>
                            <td class=\"product-list-name\"><a href=\"\" title=\"\">Lakai endora fall gray</a></td>
                            <td class=\"product-list-cat\">Mikiny</td>
                            <td class=\"product-list-manufacturer\">Lakai</td>
                            <td class=\"product-list-sex\">Muži</td>
                            <td class=\"product-list-price-old\">1600</td>
                            <td class=\"product-list-price-new\">1544</td>
                            <td class=\"product-list-discount\">32%</td>
                            <td class=\"product-list-size\">XL</td>
                            <td class=\"product-list-count\">2</td>
